...
public class TowerFirstDefenderEndurance : EnduranceFunctionality, IDamageable
{
    public bool CanBeHurt => CanGetDamaged() == LevelOfDestruction.FirstDefender.ToString();
    ...
    {
        GameManager.Instance.AudioManager.SoundToPlay(GameManager.Instance.AudioManager.towerFirstDefenderDestroyedSound);
    }
}
